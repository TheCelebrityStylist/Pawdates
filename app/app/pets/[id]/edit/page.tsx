...
<section className="mt-4 rounded-2xl border border-black/10 bg-white p-5"><h2 className="font-medium">Nutrition</h2><p className="mt-1 text-sm text-black/60">Food, portions and feeding times. Shown on sitter and full-record share links.</p><div className="mt-4"><NutritionSection petId={id} initial={nutrition}/></div></section>
<section className="mt-4 rounded-2xl border border-black/10 bg-white p-5"><h2 className="font-medium">Grooming</h2><p className="mt-1 text-sm text-black/60">Recurring grooming tasks with the same reminder engine as treatments. Shown on sitter and full-record links.</p><div className="mt-4"><GroomingSection petId={id} initial={grooming}/></div></section>
<section className="mt-4 rounded-2xl border border-black/10 bg-white p-5"><h2 className="font-medium">Expenses</h2><p className="mt-1 text-sm text-black/60">A simple ledger with monthly and per-category totals. Owner-only — full-record links only.</p><div className="mt-4"><ExpensesSection petId={id} initial={expenses}/></div></section>
</div></main>}
